---
title: "Single file MARLOWE with PEAKS on Sample: 555510-DeNovo"
author: "Daniel Vogel"
date: "`r Sys.Date()`"
output:
  html_notebook:
...
peaks_output_path <- "PEAKS/denovo.ricin.555510.csv"
#peaks_output_path <- choose.files(multi = FALSE, caption = "Choose PEAKS output csv")

#tag_output_dir <- choose.dir(default = ".", 
#                             caption = "Choose Tag output folder.")
